...
function readConfig() {
  ...
  return {
    ...
    openaiBaseUrl: readTextEnv("CYBERBOSS_OPENAI_BASE_URL") || readTextEnv("OPENAI_BASE_URL") || readTextEnv("OPENAI_API_BASE"),
    openaiApiKey: readTextEnv("CYBERBOSS_OPENAI_API_KEY") || readTextEnv("OPENAI_API_KEY"),
    openaiModel: readTextEnv("CYBERBOSS_OPENAI_MODEL") || readTextEnv("OPENAI_MODEL"),
    openaiContextWindow: readIntEnv("CYBERBOSS_OPENAI_CONTEXT_WINDOW"),
    openaiTimeoutMs: readIntEnv("CYBERBOSS_OPENAI_TIMEOUT_MS"),
    openaiMaxToolCalls: readIntEnv("CYBERBOSS_OPENAI_MAX_TOOL_CALLS"),
    openaiEnableTools: readOptionalBoolEnv("CYBERBOSS_OPENAI_ENABLE_TOOLS") !== false,
    openaiThreadsFile: path.join(stateDir, "openai-threads.json"),
